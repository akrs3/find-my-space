    	...
    	<div class="container" style="padding-bottom: 20px">
        	...
        	<div class="row align-items-start" style="margin-top: 5px">
			    ...
			    <div class="col-2" style="margin-top: 2.5px">
			      	<img v-if="space.isFavorite" ../../assets/heart_filled.png" width="22px" height="22px" align="top">
					<img v-else ../../assets/heart_empty.png" width="22px" height="22px" align="top">
				</div>
	      	</div>
	      	...
	      	<div style="margin-top: 10px">
	      		<img ../../assets/studio_example_img.png" class="img-fluid space-content-spaceImages-image" alt="Responsive image">
	      	</div>

	      	<div class="row align-items-center" style="margin-top: 15px">
	      		<div class="col-auto" align="left">
		      		<img v-for="n in space.rating" ../../assets/start_filled.png" width="21px" height="21px" align="top" style="margin-right: 5px">
		      		<img v-for="n in remainingRating" ../../assets/star_empty.png" width="21px" height="21px" align="top" style="margin-right: 5px">
			    </div>
			    <div class="col" align="left">
	      	...
	      	<div class="row align-items-center" style="margin-top: 25px;">
	      		...
	      		<div class="col-auto" align="center">
					<img ../../assets/right_arrow.png" width="41.88px" height="14.33px">
	      		</div>
	      		<div class="col-auto" align="left">
